    ...
    return (
        <>
            ...
            <main className="overflow-x-hidden">
                ...
                <section className="bg-[var(--bg)] pb-2">
                    <div className="group relative m-auto max-w-7xl px-6">
                        <div className="flex flex-col items-center md:flex-row">
                            <div className="md:max-w-44 md:border-r md:border-[var(--border)] md:pr-6">
                                <p className="text-end text-sm text-[var(--text)]">Powering the best teams</p>
                            </div>
                            <div className="relative py-6 md:w-[calc(100%-11rem)]">
                                ...
                                <div className="absolute inset-y-0 left-0 w-20 bg-gradient-to-r from-[var(--bg)]" />
                                <div className="absolute inset-y-0 right-0 w-20 bg-gradient-to-l from-[var(--bg)]" />
    ...
    return (
        <header>
            <nav
                ...
                <div className={cn('mx-auto max-w-7xl rounded-3xl px-6 transition-all duration-300 lg:px-12', scrolled && 'bg-[var(--bg)]/50 backdrop-blur-2xl')}>
                    <motion.div
                        key={1}
                            ...
                            <div className="hidden lg:block">
                                <ul className="flex gap-8 text-sm">
                                    {menuItems.map((item, index) => (
                                        <li key={index}>
                                            <a href={item.href} className="text-[var(--text)] hover:text-[var(--text-h)] block duration-150">
                                                <span>{item.name}</span>
                                            </a>
                                        </li>
                                    ))}
                        ...
                        <div className="bg-[var(--bg)] group-data-[state=active]:block lg:group-data-[state=active]:flex mb-6 hidden w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border border-[var(--border)] p-6 shadow-2xl shadow-zinc-300/20 md:flex-nowrap lg:m-0 lg:flex lg:w-fit lg:gap-6 lg:space-y-0 lg:border-transparent lg:bg-transparent lg:p-0 lg:shadow-none dark:shadow-none dark:lg:bg-transparent">
